...
JAVA_HOME="$J17" PATH="$JAVA_HOME/bin:$PATH" ./gradlew --no-configuration-cache -Pkotlin.js.nodejs.download=false :composeApp:composeCompatibilityBrowserDistribution
